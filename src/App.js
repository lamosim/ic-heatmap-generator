...
function App() {
    ...
    const { value:requestType, bind:bindRequestType } = useInput('ALL TYPES');
    ...
    return (
        <div className="App font-body bg-gray-100">
            <div className=" bg-gray-800">
                ...
                <div className="text-xl font-bold text-white px-3 pb-1 text-opacity-60">V1.0.3</div>
            </div>
                ...
                <div className="md:col-span-1 px-4 flex flex-col">
                    ...
                    <SettingsForm bindDateStart={bindDateStart} bindTimeStart={bindTimeStart} bindDateEnd={bindDateEnd}
                        ...
                        // bindShowPIR={bindShowPIR}
                                  ...
                                  dateStart={dateStart} dateEnd={dateEnd} requestType={requestType}
                                  bindRequestType={bindRequestType}/>
                </div>
                <div className="col-span-2 px-4">
                    <PreviewMap dateStart={dateStart} timeStart={timeStart} dateEnd={dateEnd} timeEnd={timeEnd}
                        ...
                        // showPIR={showPIR}
                                ...
                                unitSupported={unitSupported} requestType={requestType} />
                </div>
